...
public class Dades implements InDades {
    ...
    public void afegirComanda(int articlePos, int clientPos, int quantitat, boolean esUrgent) throws MercatException {
        ...
        Comanda novaComanda = esUrgent ? new ComandaUrgent(client, article, quantitat) : new ComandaNormal(client, article, quantitat);
    ...
    public void cancelarComanda(int position) throws MercatException {
        ...
        this.llistaComandes.esborrar(comanda);
    }
    ...
    public ArrayList<Comanda> recuperaComandesCancelades() {
        ...
        for (Iterator<Comanda> i = this.llistaComandes.getArrayList().iterator(); i.hasNext();) {
            ...
            if (aquestaComanda instanceof ComandaUrgent) {
                comandesUrgents.add(aquestaComanda);
            }
